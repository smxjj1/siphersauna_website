  ...
  <div class="products-page">
    ...
    <section class="products-hero">
      <div class="hero-container">
        ...
        <p class="hero-subtitle">Premium sauna solutions crafted for your wellness journey</p>
      ...
      <div class="grid-layout">
        ...
        <div class="grid-container">
          ...
          <div v-else class="empty-state">
            ...
            <p>Check back later for new sauna products.</p>
          </div>
        </div>
      </div>
    </section>
...
// SEO设置
useHead({
  title: 'Products | Sipher Sauna',
  meta: [
    { name: 'description', content: 'Explore our premium sauna product collection. Outdoor and indoor sauna rooms crafted from high-quality wood materials.' }
  ]
})
...
.stat {
  ...
  color: @sauna-gold;
  padding: 8px 20px;
  background: rgba(@sauna-gold, 0.1);
  border-radius: 2rem;
  border: 1px solid rgba(@sauna-gold, 0.3);
}
...
// Grid Layout with Anchor Navigation
.grid-layout {
  max-width: 1200px;
  margin: 0 auto;
  display: flex;
...
.subcategory-separator {
  height: 1px;
  background: rgba(@sauna-wood, 0.2);
  margin: 40px 0;
}
...
.product-card {
  ...
  &:hover {
    ...
    box-shadow: 0 12px 30px rgba(@sauna-dark, 0.15);
  }
}
...
.card-placeholder {
  ...
  align-items: center;
  justify-content: center;
  background: linear-gradient(135deg, @sauna-wood-light, @sauna-cream);
...
.back-to-top {
  ...
  align-items: center;
  justify-content: center;
  box-shadow: 0 4px 15px rgba(@sauna-dark, 0.2);
  transition: all 0.3s ease;
  z-index: 900;

  &:hover {
    transform: translateY(-4px);
    box-shadow: 0 6px 20px rgba(@sauna-dark, 0.3);
  }
...
.modal-overlay {
  position: fixed;
  inset: 0;
  background: rgba(@sauna-dark, 0.85);
  z-index: 1000;
  display: flex;
  align-items: center;
  justify-content: center;
